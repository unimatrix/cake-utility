...
// https://github.com/mrclay/minify/blob/master/lib/Minify/HTML.php @ 379feab on Jan 22 2016
...
class Minify_HTML {
     ...
     * @param string $html
     *
     * @param array $options 'cssMinifier' : (optional) callback function to process content of STYLE
     * elements.
     *
    ...
    public function process() {
        ...
        $this->_html = preg_replace('/\\s+(<\\/?(?:area|article|aside|base(?:font)?|blockquote|body' . '|canvas|caption|center|col(?:group)?|dd|dir|div|dl|dt|fieldset|figcaption|figure|footer|form' . '|frame(?:set)?|h[1-6]|head|header|hgroup|hr|html|legend|li|link|main|map|menu|meta|nav' . '|ol|opt(?:group|ion)|output|p|param|section|t(?:able|body|head|d|h||r|foot|itle)' . '|ul|video)\\b[^>]*>)/i', '$1', $this->_html);
