...
// https://github.com/mrclay/minify/blob/master/lib/Minify/JS/ClosureCompiler.php @ 379feab on Jan 22 2016
...
class Minify_JS_ClosureCompiler {
     ...
     */
    protected $fallbackMinifier = array(
            'JSMin\\JSMin',
            'minify'
    );
    ...
    protected function buildPostBody($js, $returnErrors = false) {
        return http_build_query(array_merge(self::$DEFAULT_OPTIONS, $this->additionalOptions, array(
                'js_code' => $js,
